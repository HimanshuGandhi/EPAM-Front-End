...
return (
    <div id='styl'>
      <div id='lst'>
        <button className='btn1' onClick={() => sortStudents("marks")}><FontAwesomeIcon icon="fa-solid fa-filter" size="lg" /> Sort by Grade {sortType === "marks" && (sortOrder === "asc" ? "▲" : "▼")}</button>
        <button  className='btn2'  onClick={() => sortStudents("name")}><FontAwesomeIcon icon="fa-solid fa-filter" size="lg" /> Sort A-Z {sortType === "name" && (sortOrder === "asc" ? "▲" : "▼")}</button>
        <button  className='btn3' onClick={() => sortStudents("status")}><FontAwesomeIcon icon="fa-solid fa-filter" size="lg" /> Sort Pass/Fail</button>

        
        <label>
        <input type="text" placeholder="Enter the Name" value={searchTerm} onChange={searchStudents}/>&nbsp;<FontAwesomeIcon icon="fa-solid fa-magnifying-glass" /></label>
